        ...
        {history.length > 0 && (
          <div className="flex items-center justify-between border-t border-cardBorder px-6 py-4 mt-auto">
            <span className="text-sm text-[#606060] truncate mr-4">
              &ldquo;{history.length} of {history.length} sources&rdquo;
            </span>
