...
export default function Step1Identify({ formData, setFormData, errors }) {
  ...
  const sectorOptions = ACTIVITY_SECTOR_OPTIONS.filter(opt => opt.value !== "all");
    ...
    <div className="flex flex-col gap-5 w-full">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-neutral-600 m-0">
          Pick the sector and write a clear title + description. Protocol ID is auto-generated from the sector on save.
        </p>
      </div>
      <div className="h-px bg-neutral-200 w-full my-1" />

      <div className="flex flex-col gap-1.5">
        <label className="text-sm text-neutral-600 font-semibold">Sector *</label>
        <Select
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-sm text-neutral-600 font-semibold">Protocol ID</label>
        <Input
          placeholder="ID"
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-sm text-neutral-600 font-semibold">Title *</label>
        <Input
          placeholder="title"
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-sm text-neutral-600 font-semibold">Description</label>
        <Input.TextArea
