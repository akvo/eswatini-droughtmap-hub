...
class UploadStatus:
    """Lifecycle of one DatasetUpload row (PA-6 D-15).

    A rejected upload is still stored: it is evidence of what was attempted,
    and it is where the row numbers live.
    """
...
class UploadOrigin:
    upload = "upload"      # operator, via the admin add form (phase 1)
    geonode = "geonode"    # provider, via the category poller (phase 2)
    revert = "revert"      # generated by reverting an applied upload (D-10)
